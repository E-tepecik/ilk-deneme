...
public class C01_ReadExcell extends TestBase {
    @Test
    public void readExcelTest1() throws IOException {
        ...
        //excell tablosundaki tüm tabloyu konsola yazdırınız
        int sonstr=workbook.getSheet("Sayfa1").getLastRowNum();
        String tablo="" ;

        for (int i = 0; i <sonstr ; i++) {
